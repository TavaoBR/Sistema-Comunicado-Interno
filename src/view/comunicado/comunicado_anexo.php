            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <?php 
                         if(isset($_SESSION['sucesso_com_arquivo'])){
                            echo $_SESSION['sucesso_com_arquivo'];
                            unset($_SESSION['sucesso_com_arquivo']);
                         }

                         if(isset($_SESSION['erro_com_arquivo'])){
                              echo $_SESSION['erro_com_arquivo'];
                              unset($_SESSION['erro_com_arquivo']);
                         }
                        ?>
                ...
                <div class="form-check">
                  ...
                  <p><button id="btnCheckFalse" class="btn btn-danger">Desmarcar todos</button></p>
                        ...
                        <form class="requires-validation" method="POST" action="../../controler/cadastro/enviar_com_anexo.php" enctype="multipart/form-data">
...
<br>
                            ...
                            <div class="col-md-12">
                                <label class='form-check-label'>Anexo de arquivo ou imagem:</label>
                                <input class="form-control" type="file" name="anexo[]" multiple accept="">
                            </div>
